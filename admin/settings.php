			...
			<form method="post">
				...
				<div id="tabs">
					<ul class="nav nav-tabs" role="tablist">
						<li role="presentation" class="active"><a href="#wpsite_div_twitter" aria-controls="wpsite_div_twitter" role="tab" data-toggle="tab"><?php _e('Twitter', self::$text_domain); ?></a></li>
						<li role="presentation"><a href="#wpsite_div_facebook" aria-controls="wpsite_div_facebook" role="tab" data-toggle="tab"><?php _e('Facebook',self::$text_domain); ?></a></li>
						<li role="presentation"><a href="#wpsite_div_google" aria-controls="wpsite_div_google" role="tab" data-toggle="tab"><?php _e('Google+',self::$text_domain); ?></a></li>
						<li role="presentation"><a href="#wpsite_div_linkedin" aria-controls="wpsite_div_linkedin" role="tab" data-toggle="tab"><?php _e('LinkedIn',self::$text_domain); ?></a></li>
						<li role="presentation"><a href="#wpsite_div_pinterest" aria-controls="wpsite_div_pinterest" role="tab" data-toggle="tab"><?php _e('Pinterest',self::$text_domain); ?></a></li>
						<li role="presentation"><a href="#wpsite_div_youtube" aria-controls="wpsite_div_youtube" role="tab" data-toggle="tab"><?php _e('YouTube',self::$text_domain); ?></a></li>
						<li role="presentation"><a href="#wpsite_div_tumblr" aria-controls="wpsite_div_tumblr" role="tab" data-toggle="tab"><?php _e('Tumblr',self::$text_domain); ?></a></li>
						<li role="presentation"><a href="#wpsite_div_order" aria-controls="wpsite_div_order" role="tab" data-toggle="tab"><?php _e('Order',self::$text_domain); ?></a></li>
						<li role="presentation"><a href="#wpsite_div_shortcode" aria-controls="wpsite_div_shortcode" role="tab" data-toggle="tab"><?php _e('ShortCode',self::$text_domain); ?></a></li>
					</ul>
    					...
    					<div role="tabpanel" class="tab-pane active" id="wpsite_div_twitter">
    							...
    							<div>
    								...
    								<div class="form-group">
                                		...
                                		<div class="col-sm-9">
                                			<input class="form-control" id="<?php echo self::$prefix; ?>settings_twitter_active" name="<?php echo self::$prefix; ?>settings_twitter_active" type="checkbox"/>
