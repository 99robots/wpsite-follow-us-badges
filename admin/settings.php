...
-->
					...
					<div id="wpsite_div_shortcode" class="metabox-holder">
						...
						<div class="postbox">
							<h3><?php _e('Parameters', self::$text_domain); ?></h3>
							<div class="inside">
								...
								<table class="wp-list-table widefat fixed posts">
									<thead>
										<tr>
											...
											<th><?php _e("Possible Values", self::$text_domain); ?></th>
										</tr>
									</thead>
									<tfoot>
										<tr>
									...
									<tbody id="the-list">
										...
										<tr>
											<td><?php _e('title', self::$text_domain); ?></td>
											<td><?php _e('string', self::$text_domain); ?> <br/> <em><?php _e('Default: "Follow Us"', self::$text_domain); ?></em></td>
											<td><?php _e('The title for all your badges.', self::$text_domain); ?></td>
											<td><?php _e('"Follow Us"', self::$text_domain); ?></td>
										</tr>

										<!-- Twitter -->

										<tr>
											<td><?php _e('twitter', self::$text_domain); ?></td>
											<td><?php _e('string', self::$text_domain); ?> <br/> <em><?php _e('Default: ""', self::$text_domain); ?></em></td>
											<td><?php _e('Twitter username.', self::$text_domain); ?></td>
											<td><?php _e('"WPsite"', self::$text_domain); ?></td>
										</tr>

										<tr>
											<td><?php _e('twitter_link', self::$text_domain); ?></td>
											<td><?php _e('bool', self::$text_domain); ?> <br/> <em><?php _e('Default: false', self::$text_domain); ?></em></td>
											<td><?php _e('Display a static link or a socail media badge.', self::$text_domain); ?></td>
											<td><?php _e('true or false', self::$text_domain); ?></td>
										</tr>

										<tr>
											<td><?php _e('twitter_followers_count_display', self::$text_domain); ?></td>
											<td><?php _e('bool', self::$text_domain); ?> <br/> <em><?php _e('Default: true', self::$text_domain); ?></em></td>
											<td><?php _e('Display the followers count.', self::$text_domain); ?></td>
											<td><?php _e('true or false', self::$text_domain); ?></td>
										</tr>

										<tr>
											<td><?php _e('twitter_language', self::$text_domain); ?></td>
											<td><?php _e('string', self::$text_domain); ?> <br/> <em><?php _e('Default: "en"', self::$text_domain); ?></em></td>
											<td><?php _e('The language of the Twitter follow button.', self::$text_domain); ?></td>
											<td><?php
												$i = 0;
												$len = count(self::$twitter_supported_languages);
												foreach (self::$twitter_supported_languages as $lang) {
													if ($i == $len - 1) {
												       echo '"' . $lang . '"';
												    } else {
													    echo '"' . $lang . '", ';
										...
										<tr>
											<td><?php _e('twitter_width', self::$text_domain); ?></td>
											<td><?php _e('string', self::$text_domain); ?> <br/> <em><?php _e('Default: "100%"', self::$text_domain); ?></em></td>
											<td><?php _e('The width of the twitte follow button.  Pixel and precent values are accepted.', self::$text_domain); ?></td>
											<td><?php _e('Any number with a px or % value.', self::$text_domain); ?></td>
										</tr>

										<tr>
											<td><?php _e('twitter_alignment', self::$text_domain); ?></td>
											<td><?php _e('string', self::$text_domain); ?> <br/> <em><?php _e('Default: "left"', self::$text_domain); ?></em></td>
											<td><?php _e('The horizontal alignment of the twitter follow button.', self::$text_domain); ?></td>
											<td><?php _e('"left" or "right"', self::$text_domain); ?></td>
										</tr>

										<tr>
											<td><?php _e('twitter_show_screen_name', self::$text_domain); ?></td>
											<td><?php _e('bool', self::$text_domain); ?> <br/> <em><?php _e('Default: false', self::$text_domain); ?></em></td>
											<td><?php _e('Display the screenname inside the follow button.', self::$text_domain); ?></td>
											<td><?php _e('true or false', self::$text_domain); ?></td>
										</tr>

										<tr>
											<td><?php _e('twitter_size', self::$text_domain); ?></td>
											<td><?php _e('string', self::$text_domain); ?> <br/> <em><?php _e('Default: "medium"', self::$text_domain); ?></em></td>
											<td><?php _e('The size of the twitter follow button.', self::$text_domain); ?></td>
											<td><?php _e('"medium" or "large"', self::$text_domain); ?></td>
										</tr>

										<!-- Facebook -->

										<tr>
											<td><?php _e('facebook', self::$text_domain); ?></td>
											<td><?php _e('string', self::$text_domain); ?> <br/> <em><?php _e('Default: ""', self::$text_domain); ?></em></td>
											<td><?php _e('Facebook username.', self::$text_domain); ?></td>
											<td><?php _e('"WPsite"', self::$text_domain); ?></td>
										</tr>

										<tr>
											<td><?php _e('facebook_type', self::$text_domain); ?></td>
											<td><?php _e('string', self::$text_domain); ?> <br/> <em><?php _e('Default: "like"', self::$text_domain); ?></em></td>
											<td><?php _e('Either a Like or Follow button.', self::$text_domain); ?></td>
											<td><?php _e('"like" or "follow"', self::$text_domain); ?></td>
										</tr>

										<tr>
											<td><?php _e('facebook_link', self::$text_domain); ?></td>
											<td><?php _e('bool', self::$text_domain); ?> <br/> <em><?php _e('Default: false', self::$text_domain); ?></em></td>
											<td><?php _e('Display a static link or a socail media badge.', self::$text_domain); ?></td>
											<td><?php _e('true or false', self::$text_domain); ?></td>
										</tr>
										...
										<tr>
											<td><?php _e('facebook_width', self::$text_domain); ?></td>
											<td><?php _e('string', self::$text_domain); ?> <br/> <em><?php _e('Default: ""', self::$text_domain); ?></em></td>
											<td><?php _e('Accepts px only.', self::$text_domain); ?></td>
											<td><?php _e('Any number with px units, but we recommend not using this option.', self::$text_domain); ?></td>
										</tr>

										<tr>
											<td><?php _e('facebook_language', self::$text_domain); ?></td>
											<td><?php _e('string', self::$text_domain); ?> <br/> <em><?php _e('Default: "en_US"', self::$text_domain); ?></em></td>
											<td><?php _e('The language of the Facebook button.', self::$text_domain); ?></td>
											<td><?php
												$i = 0;
												$len = count(self::$facebook_supported_languages);
												foreach (self::$facebook_supported_languages as $lang) {
													if ($i == $len - 1) {
												       echo '"' . $lang . '"';
												    } else {
													    echo '"' . $lang . '", ';
										...
										<tr>
											<td><?php _e('facebook_layout', self::$text_domain); ?></td>
											<td><?php _e('string', self::$text_domain); ?> <br/> <em><?php _e('Default: "standard"', self::$text_domain); ?></em></td>
											<td><?php _e('The layout of the Facebook button.', self::$text_domain); ?></td>
											<td><?php _e('"standard", "box_count", "button_count", "button"', self::$text_domain); ?></td>
										</tr>

										<tr>
											<td><?php _e('facebook_action_type', self::$text_domain); ?></td>
											<td><?php _e('string', self::$text_domain); ?> <br/> <em><?php _e('Default: "like"', self::$text_domain); ?></em></td>
											<td><?php _e('The action_type of the follow button.', self::$text_domain); ?></td>
											<td><?php _e('"like" or "large"', self::$text_domain); ?></td>
										</tr>

										<tr>
											<td><?php _e('facebook_colorscheme', self::$text_domain); ?></td>
											<td><?php _e('string', self::$text_domain); ?> <br/> <em><?php _e('Default: "light"', self::$text_domain); ?></em></td>
											<td><?php _e('The color scheme of the follow button.', self::$text_domain); ?></td>
											<td><?php _e('"light" or "dark"', self::$text_domain); ?></td>
										</tr>

										<tr>
											<td><?php _e('facebook_show_friends_faces', self::$text_domain); ?></td>
											<td><?php _e('bool', self::$text_domain); ?> <br/> <em><?php _e('Default: false', self::$text_domain); ?></em></td>
											<td><?php _e('Display friends next to the follow button.', self::$text_domain); ?></td>
											<td><?php _e('true or false', self::$text_domain); ?></td>
										</tr>

										<tr>
											<td><?php _e('facebook_include_share_button', self::$text_domain); ?></td>
											<td><?php _e('bool', self::$text_domain); ?> <br/> <em><?php _e('Default: false', self::$text_domain); ?></em></td>
											<td><?php _e('Include a share button next to the follow button.', self::$text_domain); ?></td>
											<td><?php _e('true or false', self::$text_domain); ?></td>
										</tr>
										...
										<tr>
											<td><?php _e('google', self::$text_domain); ?></td>
											<td><?php _e('string', self::$text_domain); ?> <br/> <em><?php _e('Default: ""', self::$text_domain); ?></em></td>
											<td><?php _e('Google Plus url ID.', self::$text_domain); ?></td>
											<td><?php _e('"106771475441130344412"', self::$text_domain); ?></td>
										</tr>

										<tr>
											<td><?php _e('google_link', self::$text_domain); ?></td>
											<td><?php _e('bool', self::$text_domain); ?> <br/> <em><?php _e('Default: false', self::$text_domain); ?></em></td>
											<td><?php _e('Display a static link or a socail media badge.', self::$text_domain); ?></td>
											<td><?php _e('true or false', self::$text_domain); ?></td>
										</tr>
										...
										<tr>
											<td><?php _e('google_size', self::$text_domain); ?></td>
											<td><?php _e('string', self::$text_domain); ?> <br/> <em><?php _e('Default: "20"', self::$text_domain); ?></em></td>
											<td><?php _e('The size of the follow button.', self::$text_domain); ?></td>
											<td><?php _e('"15", "20", "24"', self::$text_domain); ?></td>
										</tr>

										<tr>
											<td><?php _e('google_annotation', self::$text_domain); ?></td>
											<td><?php _e('string', self::$text_domain); ?> <br/> <em><?php _e('Default: "bubble"', self::$text_domain); ?></em></td>
											<td><?php _e('The type of annotation the follow has.', self::$text_domain); ?></td>
											<td><?php _e('"bubble", "vertical-bubble", "none"', self::$text_domain); ?></td>
										</tr>

										<tr>
											<td><?php _e('google_language', self::$text_domain); ?></td>
											<td><?php _e('string', self::$text_domain); ?> <br/> <em><?php _e('Default: "en-US"', self::$text_domain); ?></em></td>
											<td><?php _e('The language of the Facebook button.', self::$text_domain); ?></td>
											<td><?php
												$i = 0;
												$len = count(self::$google_supported_languages);
												foreach (self::$google_supported_languages as $lang) {
													if ($i == $len - 1) {
												       echo '"' . $lang . '"';
												    } else {
													    echo '"' . $lang . '", ';
										...
										<tr>
											<td><?php _e('linkedin', self::$text_domain); ?></td>
											<td><?php _e('string', self::$text_domain); ?> <br/> <em><?php _e('Default: ""', self::$text_domain); ?></em></td>
											<td><?php _e('LinkedIn url ID.', self::$text_domain); ?></td>
											<td><?php _e('"2839460"', self::$text_domain); ?></td>
										</tr>

										<tr>
											<td><?php _e('linkedin_link', self::$text_domain); ?></td>
											<td><?php _e('bool', self::$text_domain); ?> <br/> <em><?php _e('Default: false', self::$text_domain); ?></em></td>
											<td><?php _e('Display a static link or a socail media badge.', self::$text_domain); ?></td>
											<td><?php _e('true or false', self::$text_domain); ?></td>
										</tr>
										...
										<tr>
											<td><?php _e('linkedin_type', self::$text_domain); ?></td>
											<td><?php _e('string', self::$text_domain); ?> <br/> <em><?php _e('Default: "company"', self::$text_domain); ?></em></td>
											<td><?php _e('The type of the follow button. Group and university applies only to the static link.', self::$text_domain); ?></td>
											<td><?php _e('"company", "profile", "group", "university"', self::$text_domain); ?></td>
										</tr>

										<tr>
											<td><?php _e('linkedin_count_mode', self::$text_domain); ?></td>
											<td><?php _e('string', self::$text_domain); ?> <br/> <em><?php _e('Default: "right"', self::$text_domain); ?></em></td>
											<td><?php _e('Where should the count be displayed.', self::$text_domain); ?></td>
											<td><?php _e('"right", "top", "none"', self::$text_domain); ?></td>
										</tr>

										<tr>
											<td><?php _e('linkedin_language', self::$text_domain); ?></td>
											<td><?php _e('string', self::$text_domain); ?> <br/> <em><?php _e('Default: "en_US"', self::$text_domain); ?></em></td>
											<td><?php _e('The language of the Facebook button.', self::$text_domain); ?></td>
											<td><?php
												$i = 0;
												$len = count(self::$linkedin_supported_languages);
												foreach (self::$linkedin_supported_languages as $lang) {
													if ($i == $len - 1) {
												       echo '"' . $lang . '"';
												    } else {
													    echo '"' . $lang . '", ';
										...
										<tr>
											<td><?php _e('pinterest', self::$text_domain); ?></td>
											<td><?php _e('string', self::$text_domain); ?> <br/> <em><?php _e('Default: ""', self::$text_domain); ?></em></td>
											<td><?php _e('The URL  or your Pinterest profile.', self::$text_domain); ?></td>
											<td><?php _e('"http://www.pinterest.com/wpsite/"', self::$text_domain); ?></td>
										</tr>

										<tr>
											<td><?php _e('pinterest_link', self::$text_domain); ?></td>
											<td><?php _e('bool', self::$text_domain); ?> <br/> <em><?php _e('Default: false', self::$text_domain); ?></em></td>
											<td><?php _e('Display a static link or a socail media badge.', self::$text_domain); ?></td>
											<td><?php _e('true or false', self::$text_domain); ?></td>
										</tr>
										...
										<tr>
											<td><?php _e('pinterest_name', self::$text_domain); ?></td>
											<td><?php _e('string', self::$text_domain); ?> <br/> <em><?php _e('Default: ""', self::$text_domain); ?></em></td>
											<td><?php _e('The name you want to display on the follow button.', self::$text_domain); ?></td>
											<td><?php _e('"WPsite"', self::$text_domain); ?></td>
										</tr>
										...
										<tr>
											<td><?php _e('youtube', self::$text_domain); ?></td>
											<td><?php _e('string', self::$text_domain); ?> <br/> <em><?php _e('Default: ""', self::$text_domain); ?></em></td>
											<td><?php _e('Your YoutTube channel ID.', self::$text_domain); ?></td>
											<td><?php _e('"UCF0pVplsI8R5kcAqgtoRqoA"', self::$text_domain); ?></td>
										</tr>

										<tr>
											<td><?php _e('youtube_link', self::$text_domain); ?></td>
											<td><?php _e('bool', self::$text_domain); ?> <br/> <em><?php _e('Default: false', self::$text_domain); ?></em></td>
											<td><?php _e('Display a static link or a socail media badge.', self::$text_domain); ?></td>
											<td><?php _e('true or false', self::$text_domain); ?></td>
										</tr>
										...
										<tr>
											<td><?php _e('youtube_layout', self::$text_domain); ?></td>
											<td><?php _e('string', self::$text_domain); ?> <br/> <em><?php _e('Default: "default"', self::$text_domain); ?></em></td>
											<td><?php _e('The theme of your subscribe button.', self::$text_domain); ?></td>
											<td><?php _e('"default", "full"', self::$text_domain); ?></td>
										</tr>

										<tr>
											<td><?php _e('youtube_theme', self::$text_domain); ?></td>
											<td><?php _e('string', self::$text_domain); ?> <br/> <em><?php _e('Default: "default"', self::$text_domain); ?></em></td>
											<td><?php _e('The theme of your subscribe button.', self::$text_domain); ?></td>
											<td><?php _e('"default", "dark"', self::$text_domain); ?></td>
										</tr>

										<tr>
											<td><?php _e('youtube_count', self::$text_domain); ?></td>
											<td><?php _e('bool', self::$text_domain); ?> <br/> <em><?php _e('Default: true', self::$text_domain); ?></em></td>
											<td><?php _e('Display the count of subscribers.', self::$text_domain); ?></td>
											<td><?php _e('true or false', self::$text_domain); ?></td>
										</tr>
										...
										<tr>
											<td><?php _e('tumblr', self::$text_domain); ?></td>
											<td><?php _e('string', self::$text_domain); ?> <br/> <em><?php _e('Default: ""', self::$text_domain); ?></em></td>
											<td><?php _e('Your Tumblr username.', self::$text_domain); ?></td>
											<td><?php _e('"staff"', self::$text_domain); ?></td>
										</tr>

										<tr>
											<td><?php _e('tumblr_link', self::$text_domain); ?></td>
											<td><?php _e('bool', self::$text_domain); ?> <br/> <em><?php _e('Default: false', self::$text_domain); ?></em></td>
											<td><?php _e('Display a static link or a socail media badge.', self::$text_domain); ?></td>
											<td><?php _e('true or false', self::$text_domain); ?></td>
										</tr>
										...
										<tr>
											<td><?php _e('tumblr_color', self::$text_domain); ?></td>
											<td><?php _e('string', self::$text_domain); ?> <br/> <em><?php _e('Default: "dark"', self::$text_domain); ?></em></td>
											<td><?php _e('The color of your tumblr follow button.', self::$text_domain); ?></td>
											<td><?php _e('"dark", "light"', self::$text_domain); ?></td>
										</tr>

										<tr>
											<td><?php _e('tumblr_button', self::$text_domain); ?></td>
											<td><?php _e('string', self::$text_domain); ?> <br/> <em><?php _e('Default: "2"', self::$text_domain); ?></em></td>
											<td><?php _e('The type of your tumblr follow button.', self::$text_domain); ?></td>
											<td><?php _e('"1", "2", "3"', self::$text_domain); ?></td>
										</tr>

										<!-- Order -->

										<tr>
											<td><?php _e('order', self::$text_domain); ?></td>
											<td><?php _e('string', self::$text_domain); ?> <br/> <em><?php _e('Default: "twitter, facebook, google, linkedin, pinterest, youtube, tumblr"', self::$text_domain); ?></em></td>
											<td><?php _e('The order of the social media icons.', self::$text_domain); ?></td>
											<td><?php _e('"twitter, facebook, google, linkedin, pinterest, youtube, tumblr"', self::$text_domain); ?></td>
										</tr>
